      ...
      <section className="home-consultation-cta">
        <div className="cta-con">
          <h1 className="cta-message1">
            Wondering what approach works best for your organization? We're happy to help. Schedule a complimentary 30-minute consultation with us today.
          </h1>
